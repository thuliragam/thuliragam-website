...
export default function DehydratedCTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-green-700 via-green-600 to-emerald-600 py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center text-white">
        ...
        <h2 className="mt-6 text-4xl font-bold md:text-5xl">
          Premium Dehydrated Vegetables for Every Kitchen & Business
        </h2>

        <p className="mx-auto mt-6 max-w-3xl text-lg text-green-50">
          From homes to food manufacturers, Thuliragam supplies carefully
          processed dehydrated vegetables that combine convenience, hygiene,
